...
<div class="banner" style="margin-top: 10px">
    ...
    <div class="horz-grid">
        <form action="repaidLoans" method="get" >
            <div class="row ">
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th scope="col"> Interests On loans </th>
            ...
            <form method="post" action="repaidLoans">

                <input type="hidden" value="${sessionScope.state}" name="stardate">
                <input type="hidden" value="${sessionScope.endate}" name="enddate">
